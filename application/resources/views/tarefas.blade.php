    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card py-3 px-4 my-4">
                ...
                <div class="card-body">
                    <form action="{{route('tarefas.store')}}" method="POST" class="row">
                        @csrf
                        <div class="form-group col-12">
                            <label for="titulo">Título</label>
                            <input type="text" name="dados[titulo]" id="titulo" class="form-control" value="{{ old('dados.titulo') }}">
                        </div>
                        <div class="col-4">
                            <label for="status">Status</label>
                            <select class="custom-select" name="dados[status]">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="date" name="dados[data_inicio]" id="data_inicio" class="form-control" value="{{ old('dados.data_inicio') }}">
                        </div>
                        <div class="form-group col-4">
                            <label for="data_fim">Data do Fim</label>
                            <input type="date" name="dados[data_fim]" id="data_fim" class="form-control" value="{{ old('dados.data_fim') }}">
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <textarea class="form-control" name="dados[descricao]" id="descricao" rows="10"> {{ old('dados.descricao') }}</textarea>
                        </div>
                        ...
                        <div class="form-group col-12">
                            <button class="btn btn-success btn-sm float-right">Cadastrar Tarefa</button>
                        </div>
                    </form>
                </div>
            </div>
